...
cd C:\Users\ephil\Desktop\Maxime\DEV\AFPA\generateur_de_ouf
php main.php
::Ci-dessous les commandes permettant de fermer le programme 4 secondes apres la fenetre apres la fin de l'éxécution du programme.
@echo off
::Il faut modifier le chiffre juste en dessous exprimé en seconde pour fermer plus ou moins vite.
call :attente 4         
exit
