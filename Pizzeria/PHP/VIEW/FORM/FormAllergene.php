...
switch($mode){
    ...
    case "modifier":
        {
            $formAllergene = '<form action="index.php?page=ActionAllergene&mode=modifier" method="POST">';
            $idAllergeneHidden = '<input name= "idAllergene" value="' . $unAllergene->getIdAllergene(). '" type= "hidden">';
            $disabled = '';
    ...
    case "supprimer":
        {
            $formAllergene = '<form action="index.php?page=ActionAllergene&mode=supprimer" method="POST">';
            $idAllergeneHidden = '<input name= "idAllergene" value="' . $unAllergene->getIdAllergene() . '" type= "hidden">';
            $disabled = 'disabled';
