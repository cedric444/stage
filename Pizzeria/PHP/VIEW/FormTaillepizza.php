...
if (isset($_GET['id'])) {
    ...
    $uneTaillePizza = new Taillespizzas();
}
...
switch ($mode) {
    ...
    case "modifier":
        {
            $idTaillePizzaHidden = '<input name= "idUser" value="' . $uneRecette->getIdRecette() . '" type= "hidden">';
            $disabled = '';
...
?>
            <div>
                <div class="info colonne ">
                    ...
                    <input type="text" id="libelle" <?=$disabled;?> name="libelleTaillePizza" value="<?=$uneTaillePizza->getLibelleTaillePizza();?>" required pattern="[a-zA-Z- ]{3,}">
                </div>
            ...
            echo $submit;
            echo '<a href="index.php?page=ListeTaillespizzas"><div class="bouton"><i class="far fa-arrow-alt-circle-left"></i>&nbsp Retour</div></a>';
