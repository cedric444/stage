...
foreach ($allergenes as $unAllergene) {
    ...
    echo '<div class="info colonne">
                ...
                <div class="triple centre">
                    <a href="index.php?page=FormAllergene&mode=modifier&id=' . $unAllergene->getLibelleAllergene() . '"><button class="bouton"><i class="fas fa-edit"></i> Modifier</button></a>
                    <div class="mini"></div>
                    <a href="index.php?page=FormAllergene&mode=supprimer&id=' . $unAllergene->getLibelleAllergene() . '"><button class="bouton"><i class="fas fa-trash-alt"></i> Supprimer</button></a>
